...
public class ValidationJob implements org.apache.thrift.TBase<ValidationJob, ValidationJob._Fields>, java.io.Serializable, Cloneable, Comparable<ValidationJob> {
  ...
  public @org.apache.thrift.annotation.Nullable String modelId; // required
  public @org.apache.thrift.annotation.Nullable String relative_path; // required
  public @org.apache.thrift.annotation.Nullable String full_path; // required
  public @org.apache.thrift.annotation.Nullable String type; // required
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> options; // required
  ...
  public ValidationJob(ValidationJob other) {
    ...
    if (other.isSetOptions()) {
      java.util.Map<String, String> __this__options = new java.util.HashMap<String, String>(other.options);
  ...
  public ValidationJob setModelId(@org.apache.thrift.annotation.Nullable String modelId) {
    this.modelId = modelId;
    return this;
  }
  ...
  public ValidationJob setRelative_path(@org.apache.thrift.annotation.Nullable String relative_path) {
    this.relative_path = relative_path;
    return this;
  }
  ...
  public ValidationJob setFull_path(@org.apache.thrift.annotation.Nullable String full_path) {
    this.full_path = full_path;
    return this;
  }
  ...
  public ValidationJob setType(@org.apache.thrift.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ValidationJob setOptions(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> options) {
    this.options = options;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case OPTIONS:
      if (value == null) {
        ...
        setOptions((java.util.Map<String, String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.options = new java.util.HashMap<String, String>(2*_map0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ValidationJob struct) throws org.apache.thrift.TException {
      ...
      if (struct.options != null) {
        oprot.writeFieldBegin(OPTIONS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, String> _iter4 : struct.options.entrySet())
          {
      ...
      if (struct.isSetOptions()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter5 : struct.options.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.options = new java.util.HashMap<String, String>(2*_map6.size);
