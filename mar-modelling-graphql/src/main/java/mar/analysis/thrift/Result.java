...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  public Result(Result other) {
    ...
    if (other.isSetMetamodel()) {
      ...
      for (java.util.Map.Entry<java.lang.String, java.util.List<java.lang.String>> other_element : other.metamodel.entrySet()) {
        ...
        java.lang.String __this__metamodel_copy_key = other_element_key;

        java.util.List<java.lang.String> __this__metamodel_copy_value = new java.util.ArrayList<java.lang.String>(other_element_value);
  ...
  public int compareTo(Result other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMetadata_json(), other.isSetMetadata_json());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMetadata_json()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i24 = 0; _i24 < _map21.size; ++_i24)
                {
                  _key22 = iprot.readString();
                  {
                    ...
                    _val23 = new java.util.ArrayList<java.lang.String>(_list25.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      if (struct.stats != null) {
        oprot.writeFieldBegin(STATS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter28 : struct.stats.entrySet())
          {
      ...
      if (struct.metadata != null) {
        oprot.writeFieldBegin(METADATA_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<java.lang.String>> _iter29 : struct.metadata.entrySet())
          {
            oprot.writeString(_iter29.getKey());
            {
              ...
              for (java.lang.String _iter30 : _iter29.getValue())
              {
      ...
      if (struct.isSetStats()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter33 : struct.stats.entrySet())
          {
      ...
      if (struct.isSetMetadata()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.List<java.lang.String>> _iter34 : struct.metadata.entrySet())
          {
            oprot.writeString(_iter34.getKey());
            {
              oprot.writeI32(_iter34.getValue().size());
              for (java.lang.String _iter35 : _iter34.getValue())
              {
